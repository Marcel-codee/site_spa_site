    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="<?= LINK ?>assets/visitor/img/carousel-1.jpg" alt="Image">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-lg-7 text-start">
                                <h1 class="display-1 text-white animated slideInRight mb-3">Award Winning Laboratory
                                    Center</h1>
                                <p class="mb-5 animated slideInRight">Lorem ipsum dolor sit amet, consectetur adipiscing
            ...
            <div class="carousel-item">
                <img class="w-100" src="<?= LINK ?>assets/visitor/img/carousel-2.jpg" alt="Image">
                <div class="carousel-caption">
                    <div class="container">

						...
						<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
							<div class="brands_list">
								<div class="logo_image">
									<a href="#!">
										<img src="<?= LINK ?>assets/visitor/assets/images/brands/img_01.png" alt="logo_not_found">
									</a>
								</div>

								<div class="logo_image">
									<a href="#!">
										<img src="<?= LINK ?>assets/visitor/assets/images/brands/img_02.png" alt="logo_not_found">
									</a>
								</div>

								<div class="logo_image">
									<a href="#!">
										<img src="<?= LINK ?>assets/visitor/assets/images/brands/img_03.png" alt="logo_not_found">
									</a>
								</div>

								<div class="logo_image">
									<a href="#!">
										<img src="<?= LINK ?>assets/visitor/assets/images/brands/img_04.png" alt="logo_not_found">
									</a>
								</div>
							</div>
						</div>

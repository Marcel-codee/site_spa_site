                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ajout d'un employé</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        ...
                        <p class="mb-30">Ajout d'un employé</p>
                    </div>
                </div>
                    <?php if (!empty($error)): ?>
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input name="nom" class="form-control" type="text" placeholder="Nom de l'employé">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Prenom</label>
                        <div class="col-sm-12 col-md-10">
                            <input name="prenom" class="form-control" type="text" placeholder="Prénom de l'employé">
                        </div>
                    </div>                   
                    <div class="form-group row">

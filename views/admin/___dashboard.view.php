<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="<?= LINK?>assets/admin/vendors/images/deskapp-logo.svg" alt=""></div>
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								<li>
									<a href="#">
										<img src="<?= LINK?>assets/admin/vendors/images/img.jpg" alt="">
										<h3>John Doe</h3>
								...
								<li>
									<a href="#">
										<img src="<?= LINK?>assets/admin/vendors/images/photo1.jpg" alt="">
										<h3>Lea R. Frith</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="<?= LINK?>assets/admin/vendors/images/photo2.jpg" alt="">
								...
								<li>
									<a href="#">
										<img src="<?= LINK?>assets/admin/vendors/images/photo3.jpg" alt="">
										<h3>John Doe</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="<?= LINK?>assets/admin/vendors/images/photo4.jpg" alt="">
				...
				<ul id="accordion-menu">
					...
					<li>
						<a href="https://dropways.github.io/deskapp-free-single-page-website-template/" target="_blank" class="dropdown-toggle no-arrow">
							...
							<span class="mtext">Landing Page <img src="<?= LINK?>assets/admin/vendors/images/coming-soon.png" alt="" width="25"></span>
						</a>
					</li>
				</ul>
			</div>
		...
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					<div class="col-md-4">
						<img src="<?= LINK?>assets/admin/vendors/images/banner-img.png" alt="">
					</div>
					<div class="col-md-8">
			...
			<div class="card-box mb-30">
				...
				<table class="data-table table nowrap">
					...
					<tbody>
						<tr>
							<td class="table-plus">
								<img src="<?= LINK?>assets/admin/vendors/images/product-1.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="<?= LINK?>assets/admin/vendors/images/product-2.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="<?= LINK?>assets/admin/vendors/images/product-3.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="<?= LINK?>assets/admin/vendors/images/product-4.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="<?= LINK?>assets/admin/vendors/images/product-5.jpg" width="70" height="70" alt="">
							</td>
							<td>

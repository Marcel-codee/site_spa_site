<main>
				...
				<div class="container">
					<div class="row align-items-center justify-content-lg-between">
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInLeft" data-wow-delay=".1s">
							<h1 class="page_title mb-0">Service Details</h1>
						</div>
						...
						<div class="col-lg-8 col-md-8">
							<div class="details_content">
								<div class="wow fadeInUp2" data-wow-delay=".1s">
									<h2 class="item_title mb_15">Banner Printing</h2>
									<p class="mb_30">
								...
								<div class="details_image mb_30 wow fadeInUp2" data-wow-delay=".3s">
									<img src="<?= LINK ?>assets/visitor/assets/images/details/service/img_01.jpg" alt="image_not_found">
								</div>
								...
								<div class="design_guideline_info mb_50">
									...
									<div class="guideline_content wow fadeInUp2" data-wow-delay=".1s">
										...
										<p class="mb_30">
											Sed ut perspicias unde omnis iste natus error sit voluptate accusntium dolorem que laudantium totam rem aper
										</p>
								...
								<div class="details_image mb_30 wow fadeInUp2" data-wow-delay=".1s">
									<img src="<?= LINK ?>assets/visitor/assets/images/details/service/img_02.jpg" alt="image_not_found">
								</div>
						...
						<div class="col-lg-4 col-md-8">
							<aside class="sidebar_section clearfix">
								...
								<div class="widget wow fadeInUp2 sb_banner p-0 clearfix" data-wow-delay=".1s">
									<img src="<?= LINK ?>assets/visitor/assets/images/sidebar/banner/img_01.jpg" alt="image_not_found">
								</div>
					...
					<div class="row align-items-center justify-content-lg-between justify-content-md-center justify-content-sm-center">
						...
						<div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
							<div class="cta_content text-white">
								...
								<a class="custom_btn bg_white wow fadeInUp2" data-wow-delay=".3s" target="_blank" href="team.html">
									meet with us 
									<span><i class="fal fa-arrow-right"></i></span>
								</a>
							</div>
			...
			<section class="pricing_section sec_ptb_130 bg_gray deco_wrap clearfix">
					...
					<div class="row justify-content-center">
						<div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".3s">
							<div class="pricing_plan text-center">
								...
								<div class="item_body">
									<div class="item_icon">
										<img src="<?= LINK ?>assets/visitor/assets/images/pricing/icon_01.png" alt="image_not_found">
									</div>
									<strong class="pricing_text"><sup>$</sup>39.99</strong>
									<p class="mb-0">
										Sed ut perspiis unde omnis iste natus error sit voluptatem accusantiu dolmque laudantium totam rem aperiam
									</p>
								</div>
						...
						<div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".5s">
							<div class="pricing_plan text-center">
								...
								<div class="item_body">
									<div class="item_icon">
										<img src="<?= LINK ?>assets/visitor/assets/images/pricing/icon_02.png" alt="image_not_found">
									</div>
						...
						<div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".7s">
							<div class="pricing_plan text-center">
								...
								<div class="item_body">
									<div class="item_icon">
										<img src="<?= LINK ?>assets/visitor/assets/images/pricing/icon_03.png" alt="image_not_found">
									</div>
				...
				<div class="deco_image shape_1">
					<img src="<?= LINK ?>assets/visitor/assets/images/pricing/shape_01.png" alt="image_not_found">
				</div>
				<div class="deco_image shape_2">
					<img src="<?= LINK ?>assets/visitor/assets/images/pricing/shape_02.png" alt="image_not_found">
				</div>
			</section>
			<!-- pricing_section - end
			================================================== -->
